// ======================================================================
// clock_example_1.v generated from TopDesign.cysch
// 08/29/2025 at 11:48
...
module CharLCD_v2_20_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("251ffb92-fa17-46c0-a0b5-58e21a879015/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	wire [0:0] tmpOE__LED_Status_net;
	wire [0:0] tmpFB_0__LED_Status_net;
	wire [0:0] tmpIO_0__LED_Status_net;
	wire [0:0] tmpINTERRUPT_0__LED_Status_net;
	electrical [0:0] tmpSIOVREF__LED_Status_net;

	cy_psoc3_pins_v1_10
		#(.id("bd9c6da6-f194-44a8-bc2e-1361f5eda610"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		LED_Status
		 (.oe(tmpOE__LED_Status_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_Status_net[0:0]}),
		  .io({tmpIO_0__LED_Status_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_Status_net),
		  .interrupt({tmpINTERRUPT_0__LED_Status_net[0:0]}),
		  .annotation({Net_1782}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__LED_Status_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
