...
// Implementation specific stuff (joystick and ADC removed because no joystick)
...
int main(void)
{
    ...
    // Init eeprom (Joystick removed, was initialized here)
    psoc_eeprom_init();
