...
/* Optionally read the latest counts without waiting for a new frame (no flag cleared). */
...
/* Reset frame-ready flag (rarely needed; poll_frame already clears when it returns 1). */
