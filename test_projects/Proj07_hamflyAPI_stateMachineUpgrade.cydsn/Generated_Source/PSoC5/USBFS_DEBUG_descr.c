...
* Device Descriptors
*********************************************************************/
const uint8 CYCODE USBFS_DEBUG_DEVICE0_DESCR[18u] = {
...
* Config Descriptor  
*********************************************************************/
const uint8 CYCODE USBFS_DEBUG_DEVICE0_CONFIGURATION0_DESCR[75u] = {
/*  Config Descriptor Length               */ 0x09u,
/*  DescriptorType: CONFIG                 */ 0x02u,
/*  wTotalLength                           */ 0x4Bu, 0x00u,
...
*********************************************************************/
const uint8 CYCODE USBFS_DEBUG_STRING_DESCRIPTORS[319u] = {
/*********************************************************************
...
/*********************************************************************
* String Descriptor: "QISL, Dept of Physics, SFU"
*********************************************************************/
/* Descriptor Length                       */ 0x36u,
/* DescriptorType: STRING                  */ 0x03u,
 (uint8)'Q', 0u,(uint8)'I', 0u,(uint8)'S', 0u,(uint8)'L', 0u,(uint8)',', 0u,
 (uint8)' ', 0u,(uint8)'D', 0u,(uint8)'e', 0u,(uint8)'p', 0u,(uint8)'t', 0u,
 (uint8)' ', 0u,(uint8)'o', 0u,(uint8)'f', 0u,(uint8)' ', 0u,(uint8)'P', 0u,
 (uint8)'h', 0u,(uint8)'y', 0u,(uint8)'s', 0u,(uint8)'i', 0u,(uint8)'c', 0u,
 (uint8)'s', 0u,(uint8)',', 0u,(uint8)' ', 0u,(uint8)'S', 0u,(uint8)'F', 0u,
 (uint8)'U', 0u,
/*********************************************************************
...
*********************************************************************/
const uint8 CYCODE USBFS_DEBUG_SN_STRING_DESCRIPTOR[2] = {
...
*********************************************************************/
const T_USBFS_DEBUG_EP_SETTINGS_BLOCK CYCODE USBFS_DEBUG_DEVICE0_CONFIGURATION0_EP_SETTINGS_TABLE[3u] = {
...
const uint8 CYCODE USBFS_DEBUG_DEVICE0_CONFIGURATION0_INTERFACE_CLASS[2u] = {
0x02u, 0x0Au
};
/*********************************************************************
...
*********************************************************************/
const T_USBFS_DEBUG_LUT CYCODE USBFS_DEBUG_DEVICE0_CONFIGURATION0_TABLE[5u] = {
    {0x01u,     &USBFS_DEBUG_DEVICE0_CONFIGURATION0_DESCR},
    {0x03u,     &USBFS_DEBUG_DEVICE0_CONFIGURATION0_EP_SETTINGS_TABLE},
    {0x00u,    NULL},
    {0x00u,    NULL},
    {0x00u,     &USBFS_DEBUG_DEVICE0_CONFIGURATION0_INTERFACE_CLASS}
};
/*********************************************************************
* Device Dispatch Table -- Points to the Device Descriptor and each of
*                          and Configuration Tables for this Device 
*********************************************************************/
const T_USBFS_DEBUG_LUT CYCODE USBFS_DEBUG_DEVICE0_TABLE[3u] = {
    {0x01u,     &USBFS_DEBUG_DEVICE0_DESCR},
    {0x00u,    NULL},
    {0x01u,     &USBFS_DEBUG_DEVICE0_CONFIGURATION0_TABLE}
};
/*********************************************************************
* Device Table -- Indexed by the device number.
*********************************************************************/
const T_USBFS_DEBUG_LUT CYCODE USBFS_DEBUG_TABLE[1u] = {
    {0x01u,     &USBFS_DEBUG_DEVICE0_TABLE}
};
    ...
    *  USBFS_DEBUG_GET_EXTENDED_CONFIG_DESCRIPTOR becomes the bRequest value
    *  in a host vendor device/class request
    ******************************************************************************/

    const uint8 CYCODE USBFS_DEBUG_MSOS_DESCRIPTOR[USBFS_DEBUG_MSOS_DESCRIPTOR_LENGTH] = {
    /* Descriptor Length                       */   0x12u,
    /* DescriptorType: STRING                  */   0x03u,
    /* qwSignature - "MSFT100"                 */   (uint8)'M', 0u, (uint8)'S', 0u, (uint8)'F', 0u, (uint8)'T', 0u,
                                                    (uint8)'1', 0u, (uint8)'0', 0u, (uint8)'0', 0u,
    /* bMS_VendorCode:                         */   USBFS_DEBUG_GET_EXTENDED_CONFIG_DESCRIPTOR,
    /* bPad                                    */   0x00u
    };

    /* Extended Configuration Descriptor */

    const uint8 CYCODE USBFS_DEBUG_MSOS_CONFIGURATION_DESCR[USBFS_DEBUG_MSOS_CONF_DESCR_LENGTH] = {
...
/* DIE ID string descriptor for 8 bytes ID */
    ...
    uint8 USBFS_DEBUG_idSerialNumberStringDescriptor[USBFS_DEBUG_IDSN_DESCR_LENGTH];
