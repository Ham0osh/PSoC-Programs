...
module UART_v2_50_3 (
	...
	cy_clock_v1_0
		#(.id("d3c6abe5-631d-4243-90e5-012f54919267/be0a0e37-ad17-42ca-b5a1-1a654d736358"),
		  .source_clock_id(""),
		  .divisor(0),
...
module USBFS_v3_20_5 (
	...
	cy_psoc3_pins_v1_10
		#(.id("6c7cb89b-3b09-41e2-8371-9c8786c0fcb9/8b77a6c4-10a0-4390-971c-672353e2a49c"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("6c7cb89b-3b09-41e2-8371-9c8786c0fcb9/618a72fc-5ddd-4df5-958f-a3d55102db42"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
...
module top ;
    ...
    UART_v2_50_1 UART_MOVI (
        ...
        .tx_data(Net_401),
        .tx_en(Net_402),
        .tx_interrupt(Net_403));
    defparam UART_MOVI.Address1 = 0;
    defparam UART_MOVI.Address2 = 0;
    defparam UART_MOVI.EnIntRXInterrupt = 0;
    defparam UART_MOVI.EnIntTXInterrupt = 0;
    defparam UART_MOVI.FlowControl = 0;
    defparam UART_MOVI.HalfDuplexEn = 0;
    defparam UART_MOVI.HwTXEnSignal = 1;
    defparam UART_MOVI.NumDataBits = 8;
    defparam UART_MOVI.NumStopBits = 1;
    defparam UART_MOVI.ParityType = 0;
    defparam UART_MOVI.RXEnable = 1;
    defparam UART_MOVI.TXEnable = 1;
	...
	cy_psoc3_pins_v1_10
		#(.id("27b5dc82-7bc5-4a6c-9890-b31b36cc7cf2"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("6a89d565-3f6d-45a3-8b8b-4a81359107c9"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("8f17d227-f149-46fc-90a1-3e4250e6816b"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("1126126126.12613"),
		  .is_direct(0),
		  .is_digital(1))
		Clock_Movi
		 (.clock_out(Net_123));
    ...
    defparam Looptimer.DeviceFamily = "PSoC5";
    defparam Looptimer.InterruptOnCapture = 0;
    defparam Looptimer.InterruptOnTC = 1;
    defparam Looptimer.Resolution = 16;
    defparam Looptimer.SiliconRevision = "0";
    ...
    UART_v2_50_3 UART_SBC (
        ...
        .tx_data(Net_391),
        .tx_en(Net_392),
        .tx_interrupt(Net_393));
    defparam UART_SBC.Address1 = 0;
    defparam UART_SBC.Address2 = 0;
    defparam UART_SBC.EnIntRXInterrupt = 0;
    defparam UART_SBC.EnIntTXInterrupt = 0;
    defparam UART_SBC.FlowControl = 0;
    defparam UART_SBC.HalfDuplexEn = 0;
    defparam UART_SBC.HwTXEnSignal = 1;
    defparam UART_SBC.NumDataBits = 8;
    defparam UART_SBC.NumStopBits = 1;
    defparam UART_SBC.ParityType = 0;
    defparam UART_SBC.RXEnable = 1;
    defparam UART_SBC.TXEnable = 1;

	wire [0:0] tmpOE__Rx_SBC_net;
	wire [0:0] tmpIO_0__Rx_SBC_net;
	wire [0:0] tmpINTERRUPT_0__Rx_SBC_net;

	cy_psoc3_pins_v1_10
		#(.id("76286fae-8e70-4a13-8fce-3a253e81f4b7"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Rx_SBC
		 (.oe(tmpOE__Rx_SBC_net),
		  .y({1'b0}),
		  .fb({Net_464}),
		  .io({tmpIO_0__Rx_SBC_net[0:0]}),
		  .siovref({Net_460}),
		  .interrupt({tmpINTERRUPT_0__Rx_SBC_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Rx_SBC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Tx_SBC_net;
	wire [0:0] tmpFB_0__Tx_SBC_net;
	wire [0:0] tmpIO_0__Tx_SBC_net;
	wire [0:0] tmpINTERRUPT_0__Tx_SBC_net;

	cy_psoc3_pins_v1_10
		#(.id("f5f1ab68-5189-41bb-bcd4-e89cb1f41d3f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Tx_SBC
		 (.oe(tmpOE__Tx_SBC_net),
		  .y({Net_436}),
		  .fb({tmpFB_0__Tx_SBC_net[0:0]}),
		  .io({tmpIO_0__Tx_SBC_net[0:0]}),
		  .siovref({Net_460}),
		  .interrupt({tmpINTERRUPT_0__Tx_SBC_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Tx_SBC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Pin_Debug_Tick_net;
	wire [0:0] tmpFB_0__Pin_Debug_Tick_net;
	wire [0:0] tmpIO_0__Pin_Debug_Tick_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Debug_Tick_net;
	electrical [0:0] tmpSIOVREF__Pin_Debug_Tick_net;

	cy_psoc3_pins_v1_10
		#(.id("20a2eb7e-52e0-46af-b113-4166f8bb7d70"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Debug_Tick
		 (.oe(tmpOE__Pin_Debug_Tick_net),
		  .y({Net_412}),
		  .fb({tmpFB_0__Pin_Debug_Tick_net[0:0]}),
		  .io({tmpIO_0__Pin_Debug_Tick_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Debug_Tick_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Debug_Tick_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_Debug_Tick_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_Debug_SuperLoop_net;
	wire [0:0] tmpFB_0__Pin_Debug_SuperLoop_net;
	wire [0:0] tmpIO_0__Pin_Debug_SuperLoop_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Debug_SuperLoop_net;
	electrical [0:0] tmpSIOVREF__Pin_Debug_SuperLoop_net;

	cy_psoc3_pins_v1_10
		#(.id("a78e34cb-14ed-4311-a773-9c28d26c2cb4"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Debug_SuperLoop
		 (.oe(tmpOE__Pin_Debug_SuperLoop_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_Debug_SuperLoop_net[0:0]}),
		  .io({tmpIO_0__Pin_Debug_SuperLoop_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Debug_SuperLoop_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Debug_SuperLoop_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_Debug_SuperLoop_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_Debug_CoarseCentroid_net;
	wire [0:0] tmpFB_0__Pin_Debug_CoarseCentroid_net;
	wire [0:0] tmpIO_0__Pin_Debug_CoarseCentroid_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Debug_CoarseCentroid_net;
	electrical [0:0] tmpSIOVREF__Pin_Debug_CoarseCentroid_net;

	cy_psoc3_pins_v1_10
		#(.id("a822a910-4338-4944-8665-2c74a50176c6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		Pin_Debug_CoarseCentroid
		 (.oe(tmpOE__Pin_Debug_CoarseCentroid_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_Debug_CoarseCentroid_net[0:0]}),
		  .io({tmpIO_0__Pin_Debug_CoarseCentroid_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Debug_CoarseCentroid_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Debug_CoarseCentroid_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_Debug_CoarseCentroid_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_Debug_GimbalComms_net;
	wire [0:0] tmpFB_0__Pin_Debug_GimbalComms_net;
	wire [0:0] tmpIO_0__Pin_Debug_GimbalComms_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Debug_GimbalComms_net;
	electrical [0:0] tmpSIOVREF__Pin_Debug_GimbalComms_net;

	cy_psoc3_pins_v1_10
		#(.id("458d132a-91f8-4ede-a731-1b4b58be5b4b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		Pin_Debug_GimbalComms
		 (.oe(tmpOE__Pin_Debug_GimbalComms_net),
		  .y({Net_394}),
		  .fb({tmpFB_0__Pin_Debug_GimbalComms_net[0:0]}),
		  .io({tmpIO_0__Pin_Debug_GimbalComms_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Debug_GimbalComms_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Debug_GimbalComms_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_Debug_GimbalComms_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_Debug_SBCComms_net;
	wire [0:0] tmpFB_0__Pin_Debug_SBCComms_net;
	wire [0:0] tmpIO_0__Pin_Debug_SBCComms_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Debug_SBCComms_net;
	electrical [0:0] tmpSIOVREF__Pin_Debug_SBCComms_net;

	cy_psoc3_pins_v1_10
		#(.id("19218b9d-a857-49e0-bc81-16ec577e5b91"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Debug_SBCComms
		 (.oe(tmpOE__Pin_Debug_SBCComms_net),
		  .y({Net_464}),
		  .fb({tmpFB_0__Pin_Debug_SBCComms_net[0:0]}),
		  .io({tmpIO_0__Pin_Debug_SBCComms_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Debug_SBCComms_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Debug_SBCComms_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_Debug_SBCComms_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("0e5f262d-a2c7-4f43-a1ba-10eac82bba7f"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
	...
	wire [0:0] tmpOE__Pin_SwitchAuto_net;
	wire [0:0] tmpFB_0__Pin_SwitchAuto_net;
	wire [0:0] tmpIO_0__Pin_SwitchAuto_net;
	wire [0:0] tmpINTERRUPT_0__Pin_SwitchAuto_net;
	electrical [0:0] tmpSIOVREF__Pin_SwitchAuto_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("5bcb76eb-b788-4a15-9bc5-086d2fde9cb3"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_SwitchAuto
		 (.oe(tmpOE__Pin_SwitchAuto_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_SwitchAuto_net[0:0]}),
		  .io({tmpIO_0__Pin_SwitchAuto_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_SwitchAuto_net),
		  .interrupt({tmpINTERRUPT_0__Pin_SwitchAuto_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_SwitchAuto_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    VDAC8_v1_90_4 VDAC8_3v3Ref (
        .data(8'b00000000),
        .strobe(1'b0),
        .vOut(Net_460));
    defparam VDAC8_3v3Ref.Data_Source = 0;
    defparam VDAC8_3v3Ref.Initial_Value = 206;
    defparam VDAC8_3v3Ref.Strobe_Mode = 0;

    USBFS_v3_20_5 USBFS_DEBUG (
        .sof(Net_454),
        .vbusdet(1'b0));
    defparam USBFS_DEBUG.epDMAautoOptimization = 0;

	wire [0:0] tmpOE__Pin_Debug_MOVI_RX_net;
	wire [0:0] tmpFB_0__Pin_Debug_MOVI_RX_net;
	wire [0:0] tmpIO_0__Pin_Debug_MOVI_RX_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Debug_MOVI_RX_net;
	electrical [0:0] tmpSIOVREF__Pin_Debug_MOVI_RX_net;

	cy_psoc3_pins_v1_10
		#(.id("d92dcf8d-210e-413c-a101-d67cb9ad0449"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Debug_MOVI_RX
		 (.oe(tmpOE__Pin_Debug_MOVI_RX_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_Debug_MOVI_RX_net[0:0]}),
		  .io({tmpIO_0__Pin_Debug_MOVI_RX_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Debug_MOVI_RX_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Debug_MOVI_RX_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_Debug_MOVI_RX_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
