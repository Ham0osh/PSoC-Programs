// ======================================================================
// Proj02_basicuart.v generated from TopDesign.cysch
// 09/04/2025 at 16:46
...
module Statemachine (
    input wire clock, 
    input wire Change, 
    output wire standby_val, 
    output wire slow_val, 
    output wire fast_val
);

/* ==================== Wire and Register Declarations ==================== */
localparam [1:0] Standby = 2'b00;
localparam [1:0] Slow = 2'b01;
...
assign standby_val = (standby_out);
assign slow_val = (slow_out);
assign fast_val = (fast_out);

/* ==================== State Machine: StateMachine_1 ==================== */
always @ (posedge clock)
begin : Standby_state_logic
    case(StateMachine_1)
        Standby : 
        begin
            standby_out <= (1);
...
`ifdef WARP
`define CY_BLK_DIR "D:\Program Files (x86)\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\CyStatusReg_v1_90"
`include "D:\Program Files (x86)\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\CyStatusReg_v1_90\CyStatusReg_v1_90.v"
`else
`define CY_BLK_DIR "D:\Program Files (x86)\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\CyStatusReg_v1_90"
`include "D:\Program Files (x86)\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\CyStatusReg_v1_90\CyStatusReg_v1_90.v"
`endif
...
module top ;
    ...
    CyStatusReg_v1_90 state_register (
        .clock(Net_15),
        .intr(Net_43),
        .status_0(Net_34),
        .status_1(Net_35),
        ...
        .status_7(1'b0),
        .status_bus(8'b0));
    defparam state_register.Bit0Mode = 0;
    defparam state_register.Bit1Mode = 0;
    defparam state_register.Bit2Mode = 0;
    defparam state_register.Bit3Mode = 0;
    defparam state_register.Bit4Mode = 0;
    defparam state_register.Bit5Mode = 0;
    defparam state_register.Bit6Mode = 0;
    defparam state_register.Bit7Mode = 0;
    defparam state_register.BusDisplay = 0;
    defparam state_register.Interrupt = 0;
    defparam state_register.MaskValue = 0;
    defparam state_register.NumInputs = 8;
