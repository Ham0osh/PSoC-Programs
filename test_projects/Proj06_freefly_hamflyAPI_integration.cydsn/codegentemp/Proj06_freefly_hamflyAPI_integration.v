// ======================================================================
// Proj06_freefly_hamflyAPI_integration.v generated from TopDesign.cysch
// 03/31/2026 at 17:40
...
module top ;
    ...
    UART_v2_50_1 UART_1 (
        ...
        .rx_clk(Net_239),
        .rx_data(Net_240),
        .rx_interrupt(Net_241),
        .tx(Net_242),
        .tx_clk(Net_243),
        .tx_data(Net_244),
        .tx_en(Net_245),
        .tx_interrupt(Net_246));
    ...
    SPI_Master_v2_50_4 SPIMaster_SDFlash (
        .clock(Net_271),
        .miso(Net_270),
        .mosi(Net_267),
        .reset(1'b0),
        .rx_interrupt(Net_273),
        .sclk(Net_268),
        .sdat(Net_274),
        .ss(Net_269),
        .tx_interrupt(Net_275));
    defparam SPIMaster_SDFlash.BidirectMode = 0;
    defparam SPIMaster_SDFlash.HighSpeedMode = 0;
    defparam SPIMaster_SDFlash.NumberOfDataBits = 8;
    defparam SPIMaster_SDFlash.ShiftDir = 0;


	cy_clock_v1_0
		#(.id("fff078dc-174b-43f9-a6fa-34a15946bf42"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(64),
		  .period("0"),
		  .is_direct(0),
	...
	cy_clock_v1_0
		#(.id("c43cd211-eca2-4834-870b-1dda4dd29e7c"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(4),
		  .period("0"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("296431d3-41d7-4080-bf9a-eadfc0a29868"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Pin_CS_net;
	wire [0:0] tmpFB_0__Pin_CS_net;
	wire [0:0] tmpIO_0__Pin_CS_net;
	wire [0:0] tmpINTERRUPT_0__Pin_CS_net;
	electrical [0:0] tmpSIOVREF__Pin_CS_net;

	cy_psoc3_pins_v1_10
		#(.id("3cc77c5b-80fb-44b3-a7c1-7d6797d5f59c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_CS
		 (.oe(tmpOE__Pin_CS_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_CS_net[0:0]}),
		  .io({tmpIO_0__Pin_CS_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_CS_net),
		  .interrupt({tmpINTERRUPT_0__Pin_CS_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_CS_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
